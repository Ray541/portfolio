...
const PreloaderVariant1 = ({ onComplete }: { onComplete: () => void }) => {
  ...
  return (
    <div className="w-full min-h-screen flex relative overflow-hidden bg-background cursor-none">
...
export default PreloaderVariant1;
