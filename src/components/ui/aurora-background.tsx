      ...
      >
        ...
        <div
          ...
          className={cn(
            ...
            showRadialGradient &&
              `[mask-image:radial-gradient(ellipse_at_100%_0%,black_10%,var(--transparent)_70%)] md:[mask-image:radial-gradient(ellipse_at_100%_0%,black_10%,var(--transparent)_50%)]`
          )}
        />
      </div>
      {children}
