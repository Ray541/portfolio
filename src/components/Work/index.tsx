    ...
    <Section sectionName="work" className="py-20 px-3 flex-col">
      ...
      <div className="flex flex-wrap items-center justify-center gap-5">
        <p className="font-semibold text-accent-foreground text-center mb-7">
          With a passion for crafting exceptional digital experiences, I have
          honed my skills in web and frontend development through hands-on
          experience and continuous learning. Below is a snapshot of my journey
          in creating dynamic, user-centric web solutions.
        </p>
